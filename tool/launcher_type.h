...
namespace c65 {
	...
	namespace tool {
		...
		enum {
			C65_TOOL_LAUNCHER_EXCEPTION_ARGUMENT_UNSUPPORTED = 0,
			C65_TOOL_LAUNCHER_EXCEPTION_INTERNAL,
		};

		#define C65_TOOL_LAUNCHER_EXCEPTION_MAX C65_TOOL_LAUNCHER_EXCEPTION_INTERNAL

		static const std::string C65_TOOL_LAUNCHER_EXCEPTION_STR[] = {
			C65_TOOL_LAUNCHER_EXCEPTION_HEADER "Unsupported argument", // C65_TOOL_LAUNCHER_EXCEPTION_ARGUMENT_UNSUPPORTED
