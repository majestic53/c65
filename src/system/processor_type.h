...
namespace c65 {
	...
	namespace system {
		...
		enum {
			...
			C65_SYSTEM_PROCESSOR_EXCEPTION_COMMAND_INVALID,
		...
		static const std::string C65_SYSTEM_PROCESSOR_EXCEPTION_STR[] = {
			...
			C65_SYSTEM_PROCESSOR_EXCEPTION_HEADER "Invalid command", // C65_SYSTEM_PROCESSOR_EXCEPTION_COMMAND_INVALID
		...
		#define RESET_STATUS (_MASK(FLAG_BREAK_INSTRUCTION) | _MASK(FLAG_INTERRUPT_DISABLE) | _MASK(FLAG_UNUSED))
	}
}
